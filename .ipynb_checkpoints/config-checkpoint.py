...
"""
dataset_to_path = {'3dpw': '../3DPW',}

SMPL_path = '../SMPL/models/'
JOINT_REGRESSOR_TRAIN_EXTRA = 'data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M_correct = 'data/J_regressor_h36m_correct.npy'
SMPL_Neutral= SMPL_path + 'basicmodel_neutral_lbs_10_207_0_v1.1.0.pkl'
SMPL_Male = SMPL_path + 'basicmodel_m_lbs_10_207_0_v1.1.0.pkl'
SMPL_Female = SMPL_path + 'basicmodel_f_lbs_10_207_0_v1.1.0.pkl'
